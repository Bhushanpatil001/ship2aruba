...
// Since I didn't install class-variance-authority yet, I'll use a simple approach or install it.
// I'll install it just to be clean.
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default: "bg-blue-600 text-white shadow-md shadow-blue-200 hover:bg-blue-700 hover:shadow-blue-300/50",
        ...
        glass: "bg-white/40 backdrop-blur-md border border-white/20 text-slate-900 hover:bg-white/60 shadow-sm",
      },
      size: {
